...
// ABIs
const RouterABI = require('../abis/ApeswapRouter.json');
const FactoryABI = require('../abis/ApeswapFactory.json');
const PairABI = require('../abis/PancakeV2Pair.json'); // Can use the same ABI as PancakeSwap V2
...
class Apeswap {
  constructor(provider, wallet) {
    ...
    this.routerAddress = config.DEX.APESWAP.ROUTER;
    this.factoryAddress = config.DEX.APESWAP.FACTORY;
    
    // ApeSwap has a fixed 0.3% swap fee for all pairs
    this.swapFee = 0.003;  // 0.3%
